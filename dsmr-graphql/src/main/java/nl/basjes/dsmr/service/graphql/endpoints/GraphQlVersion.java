...
public class GraphQlVersion extends GraphQLTypeVisitorStub {
    ...
    @Bean
    GraphQLTypeVisitor addVersionToGraphQLSchema() {
        return this;
    }
    ...
    public TraversalControl visitGraphQLObjectType(GraphQLObjectType objectType, TraverserContext<GraphQLSchemaElement> context) {
        ...
        if (objectType.getName().equals("Query")) {
            LogManager.getLogger(GraphQlVersion.class).info("Adding the `version` to the GraphQL Query.");

            // New type
            GraphQLObjectType version = GraphQLObjectType
                .newObject()
                .name("Version")
                .description("The version information of the underlying DSMR library.")
                .field(newField("gitCommitId",                "The git commit id of the DSMR library that is used"))
                .field(newField("gitCommitIdDescribeShort",   "The git describe short of the DSMR library that is used"))
                .field(newField("buildTimeStamp",             "Timestamp when the library was built."))
                .field(newField("projectVersion",             "Version of the DSMR library"))
                .field(newField("copyright",                  "Copyright notice of the DSMR library that is used"))
                .field(newField("license",                    "The software license DSMR library that is used"))
